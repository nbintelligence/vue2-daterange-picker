...
<div style="position: relative; display: inline-block;">
  ...
  <transition name="slide-fade"
              mode="out-in">
    <div class="daterangepicker dropdown-menu ltr"
         :class="pickerStyles()"
         v-if="open"
      ...
      <calendar-ranges :canSelect="in_selection"
...
export default {
  ...
  data() {
    ...
    let data = {
      locale: {
        ...default_locale, ...this.localeData
      }
    }
